...
contract TestEscrow is Test{
    ...
    function testDeployEscrowFromFactory() public {
     ...
     function testConfirmReceiptRevertsOnTokenTxFail() public {
        ...
        factory.createNewEscrow(PRICE, tokenContract, BUYER, SELLER, ARBITER, ARBITER_FEE);
        tokenContract.changePasses(false);
        vm.expectRevert(abi.encodeWithSelector(Escrow.Escrow__TotalFeeExceedsBalance.selector, PRICE, ARBITER_FEE));
     }
